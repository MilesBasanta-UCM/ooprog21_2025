...
public class DebugFour4
{
   public static void main(String args[])
   {
      ...
      DebugTrip trip1;
      DebugTrip trip2;  
      DebugTrip trip3; // change the variable name to trip3 instead of trip2
   ...
   public static void display(DebugTrip trip)
   {
      ...
      System.out.println(" Leaving from " + trip.getDepartureCity()); // typo error, it should be trip instead of trp
